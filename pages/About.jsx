    ...
    <div className={styles.about}>
      ...
      <div className={styles.specialabout}>
        ...
        <p>
          ...
          I&apos;ve also worked with Python, Racket, HTML, CSS, and JavaScript
          (Other langauges include English, Mandarin Chinese and French). In
          terms of tools, I&apos;ve worked with a couple! React, Node.js, Google
          Workspace/MS Office, MediBang, Asesprite, etc.
          <br />
          <br />I hope to briefly summarize what I&apos;m about and show you
          some of the projects I&apos;ve been working on via this website!
        </p>
